...
class RubricTest {
	...
	void calculateRubricAverage() {
		...
		studentGradeList.add(new StudentGrade(new Student("Jouhara"), gradeList));
	...
	void calculateStandardDeviation() {
		...
		studentGradeList.add(new StudentGrade(new Student("Jouhara2"), gradeList));
		studentGradeList.add(new StudentGrade(new Student("Jouhara3"), gradeList));
		studentGradeList.add(new StudentGrade(new Student("Jouhara4"), gradeList));
		Rubric rubric = new Rubric("Exam", criterionList, studentGradeList);
	...
	void calculateStandardDeviationCriterion() {
		...
		studentGradeList.add(new StudentGrade(new Student("Jouhara"), gradeList));
		studentGradeList.add(new StudentGrade(new Student("Jouhara2"), gradeList2));
		Rubric rubric = new Rubric("Exam", criterionList, studentGradeList);
